...
public class ArchiveRollingFileAppender extends AbstractOutputStreamAppender<ArchiveRollingFileManager> {
    ...
    private ArchiveRollingFileAppender(final String name,
                                       final Layout<? extends Serializable> layout,
                                       final Filter filter,
                                       final ArchiveRollingFileManager manager,
    ...
    public static ArchiveRollingFileAppender createAppender(
        ...
        final ArchiveRollingFileManager manager = ArchiveRollingFileManager.getFileManager(fileName, filePattern,
                isAppend, isBuffered, policy, strategy, advertiseURI, layout, bufferSize, isFlush, false,
                config);
        if (manager == null) {
            return null;
        }
